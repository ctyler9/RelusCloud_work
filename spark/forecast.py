...
pm_dashboard_query_file = sc.textFile('s3://relus360.datalake/query-file/forecasts.txt')
...
pm_dashboard_query.write.mode('overwrite').format("parquet").save("s3://relus360.datalake/relus360_reports/forecasts/")
glue_client = boto3.client('glue', region_name='us-east-1')
# glue_client.start_crawler(Name='relus360_reports_forecast')
job.commit()
